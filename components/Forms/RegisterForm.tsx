                ...
                if (data.errors){
                    ...
                    errors.forEach(function (error:any) {
                        switch(error.path) {
                            ...
                            case "password": {
                                setErrorPassword(error.msg)
                                break;
                            }
                            case "confirmPassword": {
                                setErrorConfirmPassword(error.msg)
                                break;
                            }
                        }
                    });
        ...
        <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black mt-[5vh] mb-[5vh]">
            ...
            <form className="my-8" onSubmit={handleSubmit}>
                ...
                <LabelInputContainer className="mb-4">
                    ...
                    <Input id="username" name="username" placeholder="AscensionBoss3000" type="text" />
                    {errorUsername && <p className="text-red-500 mt-4">{errorUsername}</p>}
                </LabelInputContainer>
                <LabelInputContainer className="mb-4">
                    <Label htmlFor="email">Email Adress</Label>
                    <Input id="email" name="email" placeholder="ascension@gmail.com" type="email" />
                ...
                <LabelInputContainer className="mb-8">
                    ...
                    />
                    {errorConfirmPassword && <p className="text-red-500 mt-4">{errorConfirmPassword}</p>}
                </LabelInputContainer>
